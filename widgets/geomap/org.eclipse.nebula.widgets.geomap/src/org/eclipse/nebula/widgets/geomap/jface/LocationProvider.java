...
public interface LocationProvider {
	 ...
	 * @param element the element for which to return the corresponding geo-location 
	 ...
	 * Use setLonLat(element, getLonLat(element).x, getLonLat(element).y) to check without side-effect.
	 * @param element the element for which to set the geo-location
	 * @param lon the new longitude
	 * @param lat the new latitude
	 * @return true if the geo-location could be set, or false, if the location is read-only
	 */
